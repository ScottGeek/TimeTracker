...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20231129220553_InitialCreate'
)
BEGIN
...
BEGIN
    ...
    VALUES (N'20231129220553_InitialCreate', N'8.0.0');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20231201193944_Projects'
)
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20231201193944_Projects', N'8.0.0');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20231201195558_ProjectDetails'
)
BEGIN
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20231201195558_ProjectDetails', N'8.0.0');
END;
GO
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20231201200953_UserProjectsRelation'
)
BEGIN
    CREATE TABLE [Users] (
        [Id] int NOT NULL IDENTITY,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20231201200953_UserProjectsRelation', N'8.0.0');
END;
GO
